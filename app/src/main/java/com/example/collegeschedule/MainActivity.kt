...
fun CollegeScheduleApp() {
    ...
    var selectedGroup by rememberSaveable { mutableStateOf("ИС-12") } // Default group
    ...
    val retrofit = remember {
        Retrofit.Builder()
            .baseUrl("http://10.0.2.2:5050/") // localhost для Android Emulator
